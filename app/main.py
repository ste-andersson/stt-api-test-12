...
from .endpoints import health, stt_ws
...
# Inkludera routers från endpoints
...
# --------------------- Endpoints --------------------
# Health endpoint flyttad till app/endpoints/health.py
# WebSocket endpoints flyttade till app/endpoints/stt_ws.py
